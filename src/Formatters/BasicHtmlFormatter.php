...
<script>
(function(){var btns=document.querySelectorAll('#copy-md');var b=btns[btns.length-1];if(!b||b.dataset.bound)return;b.dataset.bound='1';var i=btns.length-1;while(i-->0)btns[i].remove();
b.addEventListener('click',function(){var md=buildMarkdown();if(navigator.clipboard&&navigator.clipboard.writeText){navigator.clipboard.writeText(md).then(function(){b.classList.add('copied');b.title='Copied!';setTimeout(function(){b.classList.remove('copied');b.title='Copy as Markdown'},1000)})}else{var t=document.createElement('textarea');t.value=md;t.style.position='fixed';t.style.opacity='0';document.body.appendChild(t);t.select();document.execCommand('copy');document.body.removeChild(t);b.classList.add('copied');b.title='Copied!';setTimeout(function(){b.classList.remove('copied');b.title='Copy as Markdown'},1000)}});
